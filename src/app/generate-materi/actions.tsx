...
const model = genAI.getGenerativeModel({
  ...
  systemInstruction:
    "aku akan membuat sebuah aplikasi untuk menggenerate materi secara otomatis. Prompt selanjutnya adalah konteks dari materinya. Responsenya langsung materinya saja. Berikan materi secara lengkap",
});
