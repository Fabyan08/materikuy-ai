  ...
  return (
    <main className="relative flex pt-28 md:px-20 pb-36 w-full flex-col items-center justify-center overflow-hidden text-white">
      ...
      <div className="container relative z-10 flex">
        <aside className="bg-[url('/bgauth.png')] bg-cover flex-1 rounded-l-3xl relative hidden md:flex justify-center items-center">
        ...
        <aside className="bg-white bg-opacity-20 backdrop-blur flex-1  rounded-3xl md:rounded-r-3xl font-urbanis pt-10 pl-10 pr-5">
          <p className="font-bold text-4xl">Selamat Datang 👋🏻</p>
          <p className="text-xl">Yuk buat akun di sini!</p>
          <form
            onSubmit={signUpUser}
            className="bg-white rounded-3xl translate-y-14 py-10 px-8"
          >
            <div className="flex flex-col mb-5">
              ...
              <input
                ...
                className="rounded-2xl border border-[#4285F4] p-4 text-black font-medium duration-200 focus:outline-2 focus:outline-purple-600"
                placeholder="Email"
                required
              />
            </div>
            ...
            <p className="text-gray-400 mb-6">
              ...
              <Link
                href="/auth/signin"
                className="underline font-semibold text-[#5B75FE]"
              >
                Masuk disini!
              </Link>
            </p>
            <button
              type="submit"
              className="w-full text-lg py-5 rounded-2xl bg-gradient-to-r from-[#99A6D5] to-[#5B75FE] font-bold flex justify-center"
            >
              {isLoading ? <SpinnerLoadIcon /> : "Daftar"}
            </button>
          </form>
        </aside>
      </div>
